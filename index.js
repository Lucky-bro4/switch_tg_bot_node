...
const payment_token = '401643678:TEST:8578cf88-c950-4893-b6ab-7a4b3c834aab'
...
2. В личном кабинете выберите до 4 товаров, которые больше всего понравились, и оформите доставку, указав адрес и номер телефона для связи\n
...
2. Почта: hello.switch@yandex.ru`
      ...
      bot.sendInvoice(chatId, 'Свитч', 'Оплата заказа', 'invoce', payment_token, 'RUB', [{label: 'Оплата заказа', amount: 500 * 100}], {
        photo_url: 'mainLogo.png',
        photo_height: 300,
        photo_width: 300
      })
